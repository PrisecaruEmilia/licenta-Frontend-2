...
export class Collection extends Component {
  render() {
    return (
      <Fragment>
        <Container className="collection-products">
          <Row className="collection-products-row">
            <Col>
              <Row className="collection-products-row">
                <Col
                  className="p-3"
                ...
                <Col
                  ...
                  xs={12}
                >
                  <Card className="image-box card collection-card-begin">
                ...
                <Col
                  ...
                  xs={12}
                >
                  <Card className="image-box card collection-card-middle">
                    <div className="top-card">
            ...
            <Col
              className="p-3 last-collection-product-col-image"
              key={1}
              xl={6}
              lg={6}
              md={12}
